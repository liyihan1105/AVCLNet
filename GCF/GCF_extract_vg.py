...
class getGCF(object):
    ...
    def GCFextract(self, DATA, img, GCC, fa, cam_number, face):
        img_size = img.shape
    ...
    def au_observ(self, DATA, img, GCC, cam_number, frameNum, box):
        #box, spl_box are in img coordinate
        face = box
        fr = frameNum
        fa = int(2*fr-2)
        gcfmap = self.GCFextract(DATA, img, GCC, fa, cam_number, face)
        return gcfmap
