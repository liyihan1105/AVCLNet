...
class audioNet(nn.Module):
    ...
    def forward(self, auFr):
        ...
        out_pred = torch.mean(out_fc,axis = -1)  # 进行平均操作
        return out_pred
...
class AlexNetV1_au(_AlexNet_au):  # 该类继承了 _AlexNet_au，其中 _AlexNet_au 是 AlexNet 的基本结构定义，包含了一系列的卷积层和池化层
    output_stride = 8
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 96, 11, 2),
            _BatchNorm2d(96),  # 使用了自定义的 _BatchNorm2d 类进行批标准化
